...
\SetNoFillComment
  ...
  \Def{buildAddressDependency()}{
    ...
    \While{True}{
      ...
      \If{env.evaled $\setminus$ evaled = $\O$}{
        \Break\;
      }
    }
...
\SetNoFillComment
  ...
  \Def{eval(inst, visit)}{
    ...
    \Else{
      cons, deps = \{map(eval(\_ , visit), argList) \\ \quad \quad \quad \quad \quad \quad \quad \quad $|$ argList $\in$ inst.argLists\}
    }
  }
